...
module.exports = {
  ...
  JWT_ACCESS_SECRET: process.env.JWT_ACCESS_SECRET || 'fallback_default_jwt_access_secret_key_998877',
  JWT_REFRESH_SECRET: process.env.JWT_REFRESH_SECRET || 'fallback_default_jwt_refresh_secret_key_998877',
